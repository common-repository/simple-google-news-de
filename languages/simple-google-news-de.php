...
function build_feed($atts, $newsUrl, $iswidget) {
	...
	if($atts['query'] != '') {
		$output .= '<p class="googleattribution">News via Google. <a title="News Plug-In powered by internet-pr-beratung.de" rel="nofollow" href="' . $newsUrl . '">Noch mehr News zum Thema \'' . str_replace("+", " ", $atts['query']) . '\'</a></p>';
	}
	else {
		$output .= '<p class="googleattribution">News via Google. <a title="News Plug-In powered by internet-pr-beratung.de" rel="nofollow" href="' . $newsUrl . '">Noch mehr News entdecken</a></p>';
	}
...
class google_news_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(false, $name = __('Google News Widget', 'wp_widget_plugin', 'simple-google-news-de') );
	}
...
?>
		<!-- Start widget title -->
		<p>
		<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Titel', 'wp_widget_plugin', 'simple-google-news-de'); ?></label>
		...
		<!-- Start query options -->
		<p>
		<label for="<?php echo $this->get_field_id('query'); ?>"><?php _e('Suchbegriff (optional)', 'wp_widget_plugin', 'simple-google-news-de'); ?></label>
		...
		<!-- Start result limit -->
		<p>
		<label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e('Ergebnis Limit', 'wp_widget_plugin', 'simple-google-news-de'); ?></label>
		...
		?>
         ...
         <!-- Start region -->
		<p>
		<label for="<?php echo $this->get_field_id('region'); ?>"><?php _e('Region', 'wp_widget_plugin', 'simple-google-news-de'); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('length'); ?>"><?php _e('Länge', 'wp_widget_plugin', 'simple-google-news-de'); ?></label>
		...
		<!-- Start image options -->
		<p>
		<label for="<?php echo $this->get_field_id('images'); ?>"><?php _e('Bilder', 'wp_widget_plugin', 'simple-google-news-de'); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'sort' ); ?>"><?php _e( 'Ergebnisse sortiert nach', 'wp_widget_plugin', 'simple-google-news-de' ); ?>:</label>
					<select id="<?php echo $this->get_field_id( 'sort' ); ?>" name="<?php echo $this->get_field_name( 'sort' ); ?>">
						<option value="r" <?php selected( r, $instance['sort'] ); ?>><?php _e( 'Relevanz', 'simple-google-news-de' ); ?></option>
						<option value="n" <?php selected( n, $instance['sort'] ); ?>><?php _e( 'Datum', 'simple-google-news-de' ); ?></option>
					</select>
		</p>
...
function simple_google_news_de_options() {
	if ( !current_user_can( 'manage_options' ) )  {
		wp_die( __( 'You do not have sufficient permissions to access this page.', 'simple-google-news-de' ) );
	}
